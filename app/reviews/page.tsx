...
export default function ReviewsPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-16">
      ...
      <h1 className="font-display text-4xl sm:text-5xl font-bold mt-5 tracking-tight">Отзывы</h1>
      ...
      <div className="mt-12 grid lg:grid-cols-[1.1fr,0.9fr] gap-14">
        <div>
          {REVIEWS.length === 0 ? (
            <div className="rounded-3xl bg-panel border border-line p-10 text-center">
            ...
            <div className="space-y-4">
              {REVIEWS.map((r, i) => (
                <div key={i} className="rounded-2xl bg-panel border border-line p-5">
